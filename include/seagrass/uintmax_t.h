...
#define SEAGRASS_UINTMAX_T_ERROR_OUT_IS_NULL                    1
#define SEAGRASS_UINTMAX_T_ERROR_RESULT_IS_INCONSISTENT         2
#define SEAGRASS_UINTMAX_T_ERROR_DIVIDE_BY_ZERO                 3
#define SEAGRASS_UINTMAX_T_ERROR_QUOTIENT_IS_NULL               4
 ...
 */
bool seagrass_uintmax_t_minimum(uintmax_t a, uintmax_t b, uintmax_t *out);
 ...
 */
bool seagrass_uintmax_t_maximum(uintmax_t a, uintmax_t b, uintmax_t *out);
 ...
 */
bool seagrass_uintmax_t_add(uintmax_t a, uintmax_t b, uintmax_t *out);
 ...
 */
bool seagrass_uintmax_t_subtract(uintmax_t a, uintmax_t b, uintmax_t *out);
 ...
 * values' result is not consistent.
 */
bool seagrass_uintmax_t_multiply(uintmax_t a, uintmax_t b, uintmax_t *out);
 ...
 * @throws SEAGRASS_UINTMAX_T_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
bool seagrass_uintmax_t_times_and_a_half_even(uintmax_t current,
                                              uintmax_t *out);
