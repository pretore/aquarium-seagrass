...
static void check_uintmax_t_minimum_error_on_out_is_null(void **state) {
    ...
    assert_false(seagrass_uintmax_t_minimum(1, 1, NULL));
    assert_int_equal(SEAGRASS_UINTMAX_T_ERROR_OUT_IS_NULL, seagrass_error);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
static void check_uintmax_t_minimum(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    uintmax_t result;
    assert_true(seagrass_uintmax_t_minimum(1, UINTMAX_MAX, &result));
    assert_int_equal(1, result);
    assert_true(seagrass_uintmax_t_minimum(UINTMAX_MAX, 10, &result));
...
static void check_uintmax_t_maximum_error_on_out_is_null(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    assert_false(seagrass_uintmax_t_maximum(1, 1, NULL));
    assert_int_equal(SEAGRASS_UINTMAX_T_ERROR_OUT_IS_NULL, seagrass_error);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
static void check_uintmax_t_maximum(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    uintmax_t result;
    assert_true(seagrass_uintmax_t_maximum(32, 121, &result));
    assert_int_equal(121, result);
    assert_true(seagrass_uintmax_t_maximum(UINTMAX_MAX, 21, &result));
    assert_int_equal(UINTPTR_MAX, result);
    seagrass_error = SEAGRASS_ERROR_NONE;
}

static void check_uintmax_t_add_error_on_out_is_null(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    assert_false(seagrass_uintmax_t_add(0, 1, NULL));
    assert_int_equal(SEAGRASS_UINTMAX_T_ERROR_OUT_IS_NULL, seagrass_error);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
static void check_uintmax_t_add_error_on_result_is_inconsistent(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    uintmax_t result;
    assert_false(seagrass_uintmax_t_add(SIZE_MAX, 1, &result));
    assert_int_equal(SEAGRASS_UINTMAX_T_ERROR_RESULT_IS_INCONSISTENT,
                     seagrass_error);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
static void check_uintmax_t_add(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    uintmax_t result;
    assert_true(seagrass_uintmax_t_add(0, 1, &result));
    assert_int_equal(1, result);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
static void check_uintmax_t_subtract_error_on_out_is_null(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    assert_false(seagrass_uintmax_t_subtract(1, 1, NULL));
    assert_int_equal(SEAGRASS_UINTMAX_T_ERROR_OUT_IS_NULL, seagrass_error);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
check_uintmax_t_subtract_error_on_result_is_inconsistent(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    assert_false(seagrass_uintmax_t_subtract(0, UINTPTR_MAX, (void *)1));
    assert_int_equal(SEAGRASS_UINTMAX_T_ERROR_RESULT_IS_INCONSISTENT,
                     seagrass_error);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
static void check_uintmax_t_subtract(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    uintmax_t result;
    assert_true(seagrass_uintmax_t_subtract(0, 0, &result));
    assert_int_equal(0, result);
    assert_true(seagrass_uintmax_t_subtract(UINTPTR_MAX, UINTPTR_MAX, &result));
    assert_int_equal(0, result);
    assert_true(seagrass_uintmax_t_subtract(100, 99, &result));
    assert_int_equal(1, result);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
static void check_uintmax_t_multiply_error_on_out_is_null(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    assert_false(seagrass_uintmax_t_multiply(1, 3, NULL));
    assert_int_equal(SEAGRASS_UINTMAX_T_ERROR_OUT_IS_NULL, seagrass_error);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
check_uintmax_t_multiply_error_on_result_is_inconsistent(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    uintmax_t result;
    assert_false(seagrass_uintmax_t_multiply(2, UINTMAX_MAX, &result));
    assert_int_equal(SEAGRASS_UINTMAX_T_ERROR_RESULT_IS_INCONSISTENT,
                     seagrass_error);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
static void check_uintmax_t_multiply(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    uintmax_t result;
    assert_true(seagrass_uintmax_t_multiply(0, UINTMAX_MAX, &result));
    assert_int_equal(0, result);
    assert_true(seagrass_uintmax_t_multiply(UINTMAX_MAX, 0, &result));
    assert_int_equal(0, result);
    assert_true(seagrass_uintmax_t_multiply(2, 2, &result));
...
static void check_uintmax_t_divide_error_on_quotient_is_null(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    assert_false(seagrass_uintmax_t_divide(1, 1, NULL, (void *)1));
    assert_int_equal(SEAGRASS_UINTMAX_T_ERROR_QUOTIENT_IS_NULL, seagrass_error);
    seagrass_error = SEAGRASS_ERROR_NONE;
}

static void check_uintmax_t_divide_error_on_divide_by_zero(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    assert_false(seagrass_uintmax_t_divide(1, 0, (void *)1, (void *)1));
    assert_int_equal(SEAGRASS_UINTMAX_T_ERROR_DIVIDE_BY_ZERO, seagrass_error);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
static void check_uintmax_t_divide(void **state) {
    ...
    assert_true(seagrass_uintmax_t_divide(0, 1, &quotient, NULL));
    assert_int_equal(0, quotient);
    assert_true(seagrass_uintmax_t_divide(SIZE_MAX, 1, &quotient, NULL));
    assert_int_equal(SIZE_MAX, quotient);
    assert_true(seagrass_uintmax_t_divide(22, 5, &quotient, &remainder));
...
check_uintmax_t_times_and_a_half_even_error_on_out_is_null(void **state) {
    seagrass_error = SEAGRASS_ERROR_NONE;
    assert_false(seagrass_uintmax_t_times_and_a_half_even(0, NULL));
    assert_int_equal(SEAGRASS_UINTMAX_T_ERROR_OUT_IS_NULL, seagrass_error);
    seagrass_error = SEAGRASS_ERROR_NONE;
}
...
static void check_uintmax_t_times_and_a_half_even(void **state) {
    ...
    const uintmax_t count = sizeof(pairs) / sizeof(struct pair_t);
